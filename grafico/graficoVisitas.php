...
<script type="text/javascript">
									...
									$(document).ready(function(){
										$.ajax({
											url: "./graficoDADOS/graficoVisitas.php", //URL de destino
	...
	var revenueChart = new FusionCharts({
        	...
        	"dataSource":  {
          	"chart": {
            	"caption": "Visitas à Clientes - Priscilla",
            	"subCaption": "Priscilla - Maudi",
            	"xAxisName": "Mês",
...
<body>
	<h3>Visitas Mensal referente ao Ano de <?php $ano = date(Y); echo $ano;?></h3>
