<script src="../js/InsereDependente.js"></script> 
    <?php $idBenef = $_GET['idBenef'];?>            
        <div class="container-fluid" style="margin-top:7%;">
            <div class="panel">
                <div class="panel-title">
                    <h4 class="text-info" style="margin:10px;">Adiciona Dependente</h4>
                </div>

                <form id="formD" action="" method="post" role="form" style="margin:10px;" >
                        ...
                        <table class="table table-condensed table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <?php 
                                    ...
                                    $pesquisaDependSQL = "SELECT * FROM Dependente WHERE Beneficiario_idBenef = $idBenef";
                                    $resultPesquisaDepend = mysqli_query($conexao, $pesquisaDependSQL)
                                        or die ('ERRO DE PESQUISA NA TABELA Dependente ARQUIVO AddDependente.php LINHA 142');
                                    
                                    while ($rowPesqDepend = mysqli_fetch_array($resultPesquisaDepend)){
                                                                        
                                ?>
                                    <tr>
                                        <td><?php echo $rowPesqDepend['nomeDepend'] ;?></td>
                                        <td><?php echo $rowPesqDepend['dnascDepend'] ;?></td>
                                        <td><?php echo $rowPesqDepend['certNascDepend'] ;?></td>
                                        <td><?php echo $rowPesqDepend['tituloDepend'] ;?></td>
                                        <td><?php echo $rowPesqDepend['cartaoVacina'] ;?></td>
                                        <td><?php echo $rowPesqDepend['cidadeDepend'] ;?></td>
                                        <td><?php echo $rowPesqDepend['estadoDepend'] ;?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table> 
